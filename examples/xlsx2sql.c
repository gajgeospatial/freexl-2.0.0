...
main (int argc, char *argv[])
{
    ...
    fprintf (stderr,
	     "Sorry, this version of xlsx2sql was built by disabling support XML documents\n");
    return -1;
#else
    unsigned int worksheet_index;
    const char *table_prefix = "xlsx_table";
    ...
    if (argc == 2 || argc == 3)
      ...
      {
	  fprintf (stderr, "usage: xlsx2sql path.xlsx [table_prefix]\n");
	  return -1;
      }
...
/* querying XLSX Worksheet entries */
