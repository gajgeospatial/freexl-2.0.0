...
main (int argc, char *argv[])
{
    ...
    fprintf (stderr,
	     "Sorry, this version of ods2sql was built by disabling support XML documents\n");
    return -1;
#else
    unsigned int worksheet_index;
    const char *table_prefix = "ods_table";
    ...
    if (argc == 2 || argc == 3)
      ...
      {
	  fprintf (stderr, "usage: ods2sql path.ods [table_prefix]\n");
	  return -1;
      }
